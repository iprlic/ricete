...
class MeasurmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create measurement" do
    assert_difference('Measurement.count') do
      post measurements_url, params: {measurement: {description: @measurement.description, name: @measurement.name } }
    end
  ...
  test "should update measurement" do
    patch measurement_url(@measurement), params: {measurement: {description: @measurement.description, name: @measurement.name } }
